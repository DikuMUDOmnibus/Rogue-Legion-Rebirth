...
DECLARE_SPELL_FUN( 	spell_2xexp		);
DECLARE_SPELL_FUN(	spell_deathray		);
DECLARE_SPELL_FUN(	spell_holybeam		);
DECLARE_SPELL_FUN(	spell_spiritarmor	);
DECLARE_SPELL_FUN(	spell_barkskin		);
DECLARE_SPELL_FUN(	spell_primalrage	);
DECLARE_SPELL_FUN(	spell_manatransfer	);
