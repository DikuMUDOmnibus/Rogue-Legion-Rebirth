...
void fread_obj( CHAR_DATA *ch, FILE *fp )
{
    ...
    *obj                = obj_zero;
	...
	case 'S':
	    ...
	    KEY( "Spectype2",   obj->spectype2,		fread_number( fp ) );
...
void fread_char( CHAR_DATA *ch, FILE *fp )
{
	...
	case 'A':
	    ...
	    if ( !str_cmp( word, "Affect2" ) || !str_cmp( word, "AffectData2" ) )
	    {
		AFFECT2_DATA *paf2;
	...
	case 'B':
	    ...
	    KEY( "Beast",       ch->beast,              fread_number( fp ) );
           ...
           KEY( "BankMem",     ch->pcdata->membership,   fread_number( fp ) );
	...
	KEY( "Souls",  ch->pcdata->souls, fread_number( fp ) );
	    ...
	    KEY( "Spectype2",   ch->spectype,   fread_number( fp ) );
