...
void do_jediskill( CHAR_DATA *ch, char *argument )
{
    ...
    {
		sprintf(buf,"#CB#cody#0 (#7%d#0/#77#0)#7,#C M#cind#0 (#7%d#0/#75#0)#7,#C S#cpirit#0 (#7%d#0/#76#0)#7,#C T#cechnique#0 (#7%d#0/#710#0)#n\n\r",
		...
		send_to_char(buf,ch);
		sprintf(buf, "#CYou have achieved#R %d#C jedi states, and are currently at#R %d#C.#n\n\r", ch->pcdata->powers[JEDI_STATE_MAX],ch->pcdata->powers[JEDI_STATE]);
		send_to_char(buf, ch);
		sprintf(buf2, "#CYou have achieved#R %d#C jedi points, and are currently at#R %d#C.#n\n\r", ch->pcdata->powers[JEDI_FOCUS_MAX],ch->pcdata->powers[JEDI_FOCUS]);
	...
	{
		sprintf(buf,"#RBody #0(#7%d#0)#R Mind #0(#7%d#0)#R Spirit#0 (#7%d#0)#R Technique#0 (#7%d#0)#n.\n\r",
		...
		send_to_char(buf,ch);
		sprintf(buf,"#CYou have achieved#R %d#C jedi states, and are curently at#R %d#C.#n\n\r",ch->pcdata->powers[JEDI_STATE_MAX],ch->pcdata->powers[JEDI_STATE]);
		send_to_char(buf, ch);
...
void do_jsault( CHAR_DATA *ch, char *argument )  {
	...
	else
	{
		...
		else if (ch->pcdata->stats[JEDI_COMBO_CURR] == 24)
		{
			...
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"You feel a burning as $n cuts into you with their lightsaber [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
...
//			victim->hit -= dam;
		...
		{
			sprintf(buf,"You clip $N with your lightsaber as you somersault over them [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n clips you with their lightsaber as they somersault over you [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n clips $N with their lightsaber as they jedi somersault [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
		else if (dam >= 100)
		{
			sprintf(buf,"You slice $N with your lightsaber as you somersault over them [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n slice you with their lightsaber as they somersault over you [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n slice $N with their lightsaber as they jedi somersault [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
	}
	hurt_person(ch, victim, dam);
...
void do_jreverse( CHAR_DATA *ch, char *argument )
{
	...
	else
	{
		...
		{
			sprintf(buf,"You clip $N with your lightsaber as you turn in the jedi reverse [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n clips you with their lightsaber as they turn around [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n clips $N with their lightsaber as they turn around [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
		else if (dam >= 100)
		{
			sprintf(buf,"You slice $N with your lightsaber as you turn around [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n slice you with their lightsaber as they turn around [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n slice $N with their lightsaber as they turn around [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
	}
	hurt_person(ch, victim, dam);
...
//			victim->hit -= dam;
		...
		{
			sprintf(buf,"You clip $N with your lightsaber as you kneel [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n clips you with their lightsaber as they kneel [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n clips $N with their lightsaber as they kneel [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
		else if (dam >= 100)
		{
			sprintf(buf,"You slice $N with your lightsaber as you kneel [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n slice you with their lightsaber as they kneel [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n slice $N with their lightsaber as they kneel [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
	}
	hurt_person(ch, victim, dam);
...
//			victim->hit -= dam;
		...
		{
			sprintf(buf,"You clip $N as you stab with your lightsaber [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n clips you with their lightsaber as they stab [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n clips $N with their lightsaber as they stab [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
		else if (dam >= 100)
		{
			sprintf(buf,"You slice $N with your lightsaber as you stab them [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n slice you with their lightsaber as they stab at you [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n slice $N with their lightsaber as they stab [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
	}
	hurt_person(ch, victim, dam);
...
//			victim->hit -= dam;
		...
		{
			sprintf(buf,"You clip $N as you strike with your lightsaber [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n clips you with their lightsaber as they strike [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n clips $N with their lightsaber as they strike [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
		else if (dam >= 100)
		{
			sprintf(buf,"You slice $N with your lightsaber as you strike them [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n slice you with their lightsaber as they strike at you [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n slice $N with their lightsaber as they strike [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
	}
	hurt_person(ch, victim, dam);
...
//			victim->hit -= dam;
		...
		else if ((dam >0) && (dam < 100))
		{
			...
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n clips you with their lightsaber as they upercut [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n clips $N with their lightsaber as they uppercut [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
		else if (dam >= 100)
		{
			sprintf(buf,"You slice $N with your lightsaber as you uppercut them [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n slice you with their lightsaber as they uppercut at you [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n slice $N with their lightsaber as they uppercut [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
	}
	hurt_person(ch, victim, dam);
...
//			victim->hit -= (dam/2);
		...
		{
			sprintf(buf,"You clip $N as you swing with your lightsaber [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n clips you with their lightsaber as they swing it around their body [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n clips $N with their lightsaber as they swing their light sabre around their body [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
		else if (dam >= 100)
		{
			sprintf(buf,"You slice $N with your lightsaber as you swing it [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n slice you with their lightsaber as they swing at you [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n slice $N with their lightsaber as they swing it [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
	}
	hurt_person(ch, victim, dam);
...
void do_jcross( CHAR_DATA *ch, char *argument )
{
	...
	else
	{
		...
		{
			sprintf(buf,"You clip $N as you cross with your lightsaber [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n clips you with their lightsaber as they cross you [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n clips $N with their lightsaber as they cross them [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
		else if (dam >= 100)
		{
			sprintf(buf,"You slice $N with your lightsaber as you cross them [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n slice you with their lightsaber as they cross at you [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n slice $N with their lightsaber as they cross [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
	}
	hurt_person(ch, victim, dam);
...
void do_jslash( CHAR_DATA *ch, char *argument )
{
	...
	else
	{
		...
		{
			sprintf(buf,"You clip $N as you slash with your lightsaber [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n clips you with their lightsaber as they slash [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n clips $N with their lightsaber as they slash [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
		else if (dam >= 100)
		{
			sprintf(buf,"You slice $N with your lightsaber as you slash them [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n slice you with their lightsaber as they slash at you [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n slice $N with their lightsaber as they slash [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
	}
	hurt_person(ch, victim, dam);
...
void do_jcircle( CHAR_DATA *ch, char *argument )
{
	...
	else
	{
		...
		else if ((dam >0) && (dam < 100))
		{
			...
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n clips you with their lightsaber as they circle behind you [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n clips $N with their lightsaber as they circle behind them [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
		else if (dam >= 100)
		{
			sprintf(buf,"You slice $N with your lightsaber as you circle them [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_CHAR);
			sprintf(buf,"$n slice you with their lightsaber as they circle you [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_VICT);
			sprintf(buf,"$n slice $N with their lightsaber as they circle [%d]\n\r",dam);
			act(buf,ch,NULL,victim,TO_NOTVICT);
		}
	}
	hurt_person(ch, victim, dam);
