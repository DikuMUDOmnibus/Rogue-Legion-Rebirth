...
{
			    sprintf(buf, " (#wMovement of pure magic#n)");
                            send_to_char(buf, ch);
}
  ...
  { send_to_char("            Skills:",ch);
	    ...
	    && cmd_table[cmd].discipline == 0)
	{
		...
		switch (ch->class)
		{
            ...
            case 4 : sprintf(buf, " %15s : ", "Werewolf Powers"); break;
            ...
            case CLASS_LICH:sprintf(buf, " %15s : ", "Lich Abilities");break;
            ...
            case 8192:sprintf(buf, " %15s : ", "Cyborg Powers");break;
            case 16384:sprintf(buf, " %15s : ", "Tapped Powers");break;
            case 65536:sprintf(buf, " %15s : ", "Ghoul Powers");break;
            case 131072:sprintf(buf, " %15s : ", "Thief Skills");break;
            case 262144:sprintf(buf, " %15s : ", "Magical Abilities");break;
            case 1048576:sprintf(buf, " %15s : ", "Shadow Skills");break;
            case 2097152:sprintf(buf, " %15s : ", "Priest Abilities");break;
            case 8388608:sprintf(buf, " %15s : ", "Jedi Skills");break;
            case CLASS_DRONE:sprintf(buf, " %15s : ", "Drone Powers");break;
            case CLASS_DROID:sprintf(buf, " %15s : ", "Droid Powers");break;
            case CLASS_HOBBIT:sprintf(buf, " %15s : ", "Hobbit Powers");break;
            case CLASS_FAE:sprintf(buf, " %15s : ", "Fae Powers");break;
            case CLASS_GIANT:sprintf(buf, " %15s : ", "Giant Powers");break;
	    case CLASS_SHINOBI:sprintf(buf, " %15s : ", "Shinobi Powers");break;
            case CLASS_ELEMENTAL:sprintf(buf, " %15s : ", "Elemental Powers");break;
	    case CLASS_DRAGON:sprintf(buf, " %15s : ", "Dragon Powers");break;
		}
	    }
	    else if (i % 4 == 0)
	    {
...
/*Ghoul Commands*/
    { "realms",     	do_realms,	POS_STANDING,	3, LOG_NORMAL, 65536,0,0 },
    { "gcreate",    	do_gcreate,	POS_SITTING,	3, LOG_NORMAL, 65536,0,0 },
    { "gore",       	do_gore,	POS_STANDING,	3, LOG_NORMAL, 65536,0,0 },
    { "ravage",     	do_ravage,	POS_FIGHTING,	3, LOG_NORMAL, 65536,0,0 },
    { "sdecay",     	do_sdecay,	POS_STANDING,	3, LOG_NORMAL, 65536,0,0 },
    { "sdeath",     	do_sdeath,	POS_STANDING,	3, LOG_NORMAL, 65536,0,0 },
    //{ "ghouleq",    	do_ghouleq,	POS_STANDING,	3, LOG_NORMAL, 65536,0,0 },
    { "swampwalk",    	do_swampwalk,POS_STANDING,	3, LOG_NORMAL, 65536,0,0 },
    
/*Draconians*/
    { "dragonorb",  do_dragonorb,	POS_STANDING,	 0,  LOG_NORMAL, 16384,0,0	},
    { "fieryeyes",  do_fieryeyes,	POS_FIGHTING,	 0,  LOG_NORMAL, 16384,0,0	},	
    { "spikes", do_spikes,		POS_FIGHTING,	 0,  LOG_NORMAL, 16384,0,0	},
    { "deathstate", do_deathstate,	POS_STANDING,	 0,  LOG_NORMAL, 16384,0,0	},    
    { "dclaws", do_dclaws,		POS_FIGHTING,	 0,  LOG_NORMAL, 16384,0,0	},
    { "headbash",   do_headbash,	POS_FIGHTING,	 0,  LOG_NORMAL, 16384,0,0	},
    { "acidblood",  do_acidblood,	POS_STANDING,	 0,  LOG_NORMAL, 16384,0,0	},
    { "lizardform", do_lizardform,	POS_STANDING,	 0,  LOG_NORMAL, 16384,0,0	},
    { "dtail",	    do_dtail,		POS_FIGHTING,	 0,  LOG_NORMAL, 16384,0,0	},
    { "venomspit",  do_venomspit,	POS_FIGHTING,	 0,  LOG_NORMAL, 16384,0,0	},
    { "dragonrun",  do_dragonrun,   POS_STANDING,    0,  LOG_NORMAL, 16384,0,0  },
    { "gasbreath",  do_gasbreath,	POS_FIGHTING,	 0,  LOG_NORMAL, 16384,0,0	},
    { "firebreath", do_firebreath,	POS_FIGHTING,	 0,  LOG_NORMAL, 16384,0,0	},
/*Thief Commands*/
    { "thiefskills",    do_thiefskills,	POS_STANDING,	3, LOG_NORMAL, CLASS_THIEF,0,0 },
    { "rolldice",	do_rolldice,	POS_STANDING,	3, LOG_NORMAL, CLASS_THIEF,0,0 },
    { "tconceal",	do_tconceal,	POS_STANDING,	3, LOG_NORMAL, CLASS_THIEF,0,0 },
    { "gleam",		do_gleam,	POS_STANDING,	3, LOG_NORMAL, CLASS_THIEF,0,0 },
    { "bstab",		do_bstab,	POS_STANDING,	3, LOG_NORMAL, CLASS_THIEF,0,0 },
    { "tdagger",	do_tdagger,	POS_FIGHTING,	3, LOG_NORMAL, CLASS_THIEF,0,0 },
    //{ "thiefeq",	do_thiefeq,	POS_STANDING,	3, LOG_NORMAL, CLASS_THIEF,0,0 },	
    { "dtrick",		do_dtrick,	POS_FIGHTING,	3, LOG_NORMAL, CLASS_THIEF,0,0 },
    { "poisonblade",    do_poisonblade,	POS_STANDING,	3, LOG_NORMAL, CLASS_THIEF,0,0 },
    { "shadowmove",    do_shadowmove,	POS_STANDING,	3, LOG_NORMAL, CLASS_THIEF,0,0 },

    /* shadows */
    { "moonstrike",     do_moonstrike,     POS_FIGHTING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_ATTACK,     1      },
    { "shadowthrust",   do_shadowthrust,   POS_FIGHTING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_ATTACK,     2      },
    { "dirtthrow",      do_dirtthrow,      POS_FIGHTING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_ATTACK,     4     },
    { "gutcutter",      do_gutcutter,      POS_FIGHTING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_ATTACK,     8     },
    { "soulreaper",     do_soulreaper,     POS_FIGHTING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_ATTACK,     16    },
    { "knifespin",      do_knifespin,      POS_FIGHTING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_ATTACK,     32    },
    { "wakasashislice", do_wakasashislice, POS_FIGHTING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_ATTACK,     64   },
    { "caltrops",       do_caltrops,       POS_FIGHTING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_ATTACK,     128   },
    { "shadowlearn",    do_shadowlearn,    POS_STANDING,  3,  LOG_NORMAL,CLASS_SHADOW,    0,                 0      },
    { "soulseek",       do_soulseek,       POS_STANDING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_POWERS,     512     },
    { "soultarget",     do_soultarget,     POS_FIGHTING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_POWERS,     512    },
    { "shadowwalk",     do_shadowwalk,     POS_STANDING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_POWERS,     4    },
    //{ "shadowtalk",     do_shadowtalk,     POS_DEAD,      3,  LOG_NORMAL,CLASS_SHADOW,    0,                 0         },
    { "scry",           do_scry,           POS_STANDING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_POWERS,     128    },
    { "vanish",         do_vanish,         POS_STANDING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_POWERS,     2  },
    { "shield",         do_shield,         POS_STANDING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_POWERS,     256      },
    { "assassinate",    do_assassinate,    POS_STANDING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_POWERS,     1024     },
    { "truesight",      do_truesight,      POS_STANDING,  3,  LOG_NORMAL,CLASS_SHADOW,    SHADOW_POWERS,     16      },


    /* Priests */
    { "pgain",          do_pgain,          POS_STANDING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
    { "priestform",     do_priestform,     POS_STANDING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
    { "holyaura",       do_holyaura,       POS_STANDING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
    { "godbless",       do_godbless,       POS_STANDING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
    { "ascend",         do_ascend,         POS_STANDING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
	{ "godheal",        do_godheal,        POS_STANDING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
    { "godpeace",       do_godpeace,       POS_STANDING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
    { "godstrike",      do_godstrike,      POS_FIGHTING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
    { "grheal",         do_grheal,         POS_STANDING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
    { "grstorm",        do_grstorm,        POS_STANDING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
    { "healstorm",      do_healstorm,      POS_STANDING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
    { "majorheal",      do_majorheal,      POS_FIGHTING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
    { "minheal",        do_minheal,        POS_FIGHTING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
    { "minstorm",       do_minstorm,       POS_FIGHTING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
    { "pwho",           do_pwho,           POS_FIGHTING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },
    { "turn",           do_turnundead,     POS_FIGHTING,  3,  LOG_NORMAL,CLASS_PRIEST, 0,  0    },            
...
//	{ "setshin",	do_shinflag,	POS_STANDING,   12,	LOG_NORMAL,	0,0,0},
  ...
  */
    ...
    { "disburse",  do_disburse, POS_STANDING,  3, LOG_NORMAL, CLASS_ELEMENTAL,0,0 },
    ...
    { "jfight", do_jfight, POS_FIGHTING, 3, LOG_NORMAL,8388608,0,0},
    { "jstate",		do_jstate,	POS_FIGHTING, 3, LOG_NORMAL,8388608,0,0},
    { "jstep",		do_jstep,	POS_STANDING, 3, LOG_NORMAL,8388608,0,0},
    //{ "forcetalk",	do_forcetalk,	POS_DEAD,     3, LOG_NORMAL,8388608,0,0},
    //{ "jediarmor",	do_jediarmor,	POS_STANDING, 3, LOG_NORMAL,8388608,0,0},
    { "jedilearn",	do_jedilearn,	POS_STANDING, 3, LOG_NORMAL,8388608,0,0},
    { "jediskill",	do_jediskill,   POS_STANDING, 3, LOG_NORMAL,8388608,0,0},
    { "fshield",	do_fshield,	POS_STANDING, 3, LOG_NORMAL,8388608,0,0},
    { "jlevitate",	do_jlevitate,	POS_STANDING, 3, LOG_NORMAL,8388608,0,0},
    { "jsight",		do_jsight,	POS_STANDING, 3, LOG_NORMAL,8388608,0,0},
    { "jeyes",		do_jeyes,	POS_STANDING, 3, LOG_NORMAL,8388608,0,0},
    { "jsense",		do_jsense,	POS_STANDING, 3, LOG_NORMAL,8388608,0,0},
    { "jhealing",	do_jhealing,	POS_STANDING, 3, LOG_NORMAL,8388608,0,0},
    { "jsummon",	do_jsummon,	POS_FIGHTING, 3, LOG_NORMAL,8388608,0,0},
    { "jsault",		do_jsault,	POS_FIGHTING, 3, LOG_NORMAL,8388608,0,0},
    { "jreverse",	do_jreverse,	POS_FIGHTING, 3, LOG_NORMAL,8388608,0,0},
    { "jkneel",		do_jkneel,	POS_FIGHTING, 3, LOG_NORMAL,8388608,0,0},
    { "jstab",		do_jstab,	POS_FIGHTING, 3, LOG_NORMAL,8388608,0,0},
    { "jhigh",		do_jhigh,	POS_FIGHTING, 3, LOG_NORMAL,8388608,0,0},
    { "jupper",		do_jupper,	POS_FIGHTING, 3, LOG_NORMAL,8388608,0,0},
    { "jbutterfly",	do_jbutterfly,	POS_FIGHTING, 3, LOG_NORMAL,8388608,0,0},
    { "jcross",		do_jcross,	POS_FIGHTING, 3, LOG_NORMAL,8388608,0,0},
    { "jslash",		do_jslash,	POS_FIGHTING, 3, LOG_NORMAL,8388608,0,0},
    { "jcircle",	do_jcircle,	POS_FIGHTING, 3, LOG_NORMAL,8388608,0,0},
    { "jedishield",	do_jedishield,	POS_STANDING, 3, LOG_NORMAL,8388608,0,0},
    { "jedisleep",	do_jedisleep,	POS_STANDING, 3, LOG_NORMAL,8388608,0,0},
    { "fspeed",		do_fspeed,	POS_STANDING, 3, LOG_NORMAL,8388608,0,0},
    { "jtouch",		do_jtouch,	POS_STANDING, 3, LOG_NORMAL,8388608,0,0},
    /*
    ...
    { "consecrate",        do_consecrate,       POS_DEAD,       0,  LOG_NORMAL, 0,0,0  },
    { "symbioteadvance",   do_symbioteadvance,       POS_DEAD,       0,  LOG_NORMAL, 0,0,0  },
    { "gainsymbiote",      do_gainsymbiote,       POS_DEAD,       0,  LOG_NORMAL, 0,0,0  },
    { "objsell",        do_objsell,       POS_DEAD,       0,  LOG_NORMAL, 0,0,0  },
    { "identify",        do_identify,       POS_DEAD,       0,  LOG_NORMAL, 0,0,0  },
    { "weapsell",        do_weapsell,       POS_DEAD,       0,  LOG_NORMAL, 0,0,0  },
    { "displacerform",        do_displacerform,       POS_DEAD,       3,  LOG_NORMAL, 0,0,0  },
    ...
    { "samseye",        do_samseye,          POS_STANDING, 3, LOG_NORMAL, 16, 0, 0 },
    { "samlearn",	do_samlearn,	     POS_STANDING, 3, LOG_NORMAL, 16, 0, 0 },
    { "sword",		do_sword,	     POS_FIGHTING, 3, LOG_NORMAL, 16, 0, 0 },
...
/* Giant powers */
    ...
    { "vanish",       do_vanish,        POS_STANDING,   3,  LOG_NORMAL, CLASS_HOBBIT,0,0},
    { "hobtalk",      do_hobtalk,       POS_DEAD,       3,  LOG_NORMAL, CLASS_HOBBIT,0,0},
    { "readaura",     do_readaura,      POS_STANDING,   3,  LOG_NORMAL, CLASS_HOBBIT,0,0},
    { "shield",       do_shield,        POS_STANDING,   3,  LOG_NORMAL, CLASS_HOBBIT,0,0},
    { "truesight",    do_truesight,     POS_STANDING,   3,  LOG_NORMAL, CLASS_HOBBIT,0,0},
    { "bettercook",   do_bettercook,    POS_STANDING,   3,  LOG_NORMAL, CLASS_HOBBIT,0,0},
    { "dishes",       do_dishes,        POS_STANDING,   3,  LOG_NORMAL, CLASS_HOBBIT,0,0},
    { "cook",         do_cook,          POS_FIGHTING,   3,  LOG_NORMAL, CLASS_HOBBIT,0,0},
    { "tunnel",       do_classportal,   POS_STANDING,   3,  LOG_NORMAL, CLASS_HOBBIT,0,0},
    ...
    { "manasuck",     do_manasuck,      POS_FIGHTING,   3,  LOG_NORMAL, 256,0,0},
    ...
    { "chant",        do_chant,         POS_MEDITATING, 3,  LOG_NORMAL, 256,0,0 },
    ...
    { "reform",       do_reform,        POS_FIGHTING,   3,  LOG_NORMAL,CLASS_FAE,DISC_FAE_ARCANE,1},
    ...
    { "conjurebow",   do_conjurebow,    POS_STANDING,   3,  LOG_NORMAL,CLASS_FAE,0,0},
    { "ancients",     do_ancients,      POS_STANDING,   3,  LOG_NORMAL,CLASS_FAE,0,0},
    { "scry",         do_scry,          POS_STANDING,   3,  LOG_NORMAL,CLASS_FAE,DISC_FAE_NATURE,3},
    { "readaura",     do_readaura,      POS_FIGHTING,   3,  LOG_NORMAL,CLASS_FAE,DISC_FAE_NATURE,5},
    { "barkshift",    do_classportal,   POS_STANDING,   3,  LOG_NORMAL,CLASS_FAE,DISC_FAE_NATURE,6},
    { "djinn",        do_djinn,         POS_STANDING,   3,  LOG_NORMAL,CLASS_FAE,DISC_FAE_NATURE,8},
    { "elementalform",do_elementalform, POS_STANDING,   3,  LOG_NORMAL,CLASS_FAE,DISC_FAE_NATURE,10},
    { "vanish",       do_vanish,        POS_STANDING,   3,  LOG_NORMAL,CLASS_FAE,DISC_FAE_ARCANE,4},
    { "truesight",    do_truesight,     POS_STANDING,   3,  LOG_NORMAL,CLASS_FAE,DISC_FAE_ARCANE,6},
    { "genie",        do_genie,         POS_STANDING,   3,  LOG_NORMAL,CLASS_FAE,DISC_FAE_ARCANE,8},
    { "glamour",      do_glamour,       POS_STANDING,   3,  LOG_NORMAL,CLASS_FAE,DISC_FAE_ARCANE,10},
...
// Chimerstry
	...
	{ "scales",	    do_dscales,		POS_STANDING,	 0,  LOG_NORMAL, 16384,0,0	},    
...
/* Vamp ^^^^ */
    ...
    { "gklaive",         do_gklaive,  POS_STANDING,      3,  LOG_NORMAL, 4,DISC_WERE_LUNA,7 },
    ...
    { "collective",     do_lloth,       POS_STANDING,    3,  LOG_NORMAL, 32, 0, 0 },
...
/*end demon section*/
   ...
   { "heavenlyrain", do_heavenlyrain, POS_FIGHTING, 3, LOG_NORMAL, 0,0,0},
   { "leye",      do_truesight, POS_STANDING, 3, LOG_NORMAL, 0,0,0},
   { "reye",      do_shadowsight, POS_STANDING, 3, LOG_NORMAL, 0,0,0},
   { "eaglestrength", do_eaglestrength, POS_STANDING, 3, LOG_NORMAL, 0,0,0},
   { "hawkeyes",  do_hawkeyes,  POS_STANDING, 3, LOG_NORMAL, 0,0,0},
   { "vulturevigor", do_vulturevigor, POS_STANDING, 3, LOG_NORMAL, 0,0,0},
   ...
   { "cloudsblessing", do_cloudsblessing, POS_STANDING, 3, LOG_NORMAL, 0,0,0},
...
/* Spider Droid Powers */
 ...
 //   { "spiderarmor",    do_spiderarmor,   POS_STANDING,   3,  LOG_NORMAL, CLASS_DROID, 0, 0 },
    ...
    { "shadowwalk",     do_classportal,   POS_STANDING,   3,  LOG_NORMAL, CLASS_DROID, 0, 0 },
    { "darkness",       do_darkness,      POS_STANDING,   3,  LOG_NORMAL, CLASS_DROID, 0, 0 },
    { "radarscan",      do_radarscan,     POS_FIGHTING,   3,  LOG_NORMAL, CLASS_DROID, 0, 0 },
    { "truesight",      do_truesight,     POS_STANDING,   3,  LOG_NORMAL, CLASS_DROID, 0, 0 },
    { "battlestation",  do_battlestation, POS_FIGHTING,   3,  LOG_NORMAL, CLASS_DROID, 0, 0 },
    { "implant",        do_implant,       POS_STANDING,   3,  LOG_NORMAL, CLASS_DROID, 0, 0 },
    { "reload",         do_reload,        POS_STANDING,   3,  LOG_NORMAL, CLASS_DROID, 0, 0 },
    { "droidspeed",     do_droidspeed,    POS_FIGHTING,   3,  LOG_NORMAL, CLASS_DROID, 0, 0 },
    { "submachine",     do_submachine,    POS_FIGHTING,   3,  LOG_NORMAL, CLASS_DROID, 0, 0 },
    { "rocketblast",    do_rocketblast,   POS_FIGHTING,   3,  LOG_NORMAL, CLASS_DROID, 0, 0 },
...
/* Tag commands */
    ...
    { "mechsight",      do_infravision, POS_STANDING,   3,      LOG_NORMAL, 8192,0,0},
    ...
    { "news",         do_news,        POS_DEAD,     1, LOG_NORMAL, 0, 0, 0 },
    { "chsave",	      do_chsave,    	POS_DEAD,    11, LOG_NORMAL, 0, 0, 0 },
    { "addchange",    do_addchange, 	POS_DEAD,    11, LOG_NORMAL, 0, 0, 0 },
    { "changes",      do_news,        	POS_DEAD,     1, LOG_NORMAL, 0, 0, 0 }, 
    { "oldscore",     do_score,		POS_DEAD,	 	 0,LOG_NORMAL, 0,0,0},
    { "shoot",        do_shoot,        POS_STANDING, 1, LOG_NORMAL, CLASS_CYBORG, 0, 0 },
    { "reload",       do_reload,        POS_STANDING, 1, LOG_NORMAL, CLASS_CYBORG, 0, 0 },
    { "unload",       do_unload,        POS_STANDING, 1, LOG_NORMAL, CLASS_CYBORG, 0, 0 },
    /*
     * Immortal commands.
     */
    ...
    { "wiznet",		do_wiznet,	POS_DEAD,		 10,  LOG_ALWAYS, 0,0,0	},
    ...
    { "opedit",         do_opedit,      POS_DEAD,   11,  LOG_ALWAYS, 1 },
    { "rpedit",         do_rpedit,      POS_DEAD,   11,  LOG_ALWAYS, 1 },
    { "opdump",		do_opdump,	POS_DEAD,	7,  LOG_NEVER,  1 },
    { "mpdump",		do_mpdump,	POS_DEAD,	7,  LOG_NEVER,  1 },
    { "opstat",		do_opstat,	POS_DEAD,	7,  LOG_NEVER,  1 },
    { "rpdump",		do_rpdump,	POS_DEAD,	7,  LOG_NEVER,  1 },
    { "rpstat",		do_rpstat,	POS_DEAD,	7,  LOG_NEVER,  1 },
    ...
    { "meditate",     do_meditate,      POS_STANDING,   3,  LOG_NORMAL,CLASS_FAE,DISC_FAE_ARCANE,2},
   ...
   { "channels",       do_channels,	POS_DEAD,       0,  LOG_NORMAL, 0,0,0  },
    { "channelforce", 	do_channelforce, POS_STANDING, 3, LOG_NORMAL,CLASS_JEDI,0,0},
    
    { "arts", 		do_arts, 	POS_STANDING, 3, LOG_NORMAL,256,0,0},
    { "chaos", 		do_chaos, 	POS_FIGHTING, 3, LOG_NORMAL,256,0,0},
    { "thunderclap", 	do_thunderclap, POS_FIGHTING, 3, LOG_NORMAL,256,0,0},
    { "hellblades", 	do_hellblades, 	POS_FIGHTING, 3, LOG_NORMAL,256,0,0},
    { "wrath", 		do_wrath, 	POS_FIGHTING, 3, LOG_NORMAL,256,0,0},
    { "firebolt", 	do_firebolt, 	POS_FIGHTING, 3, LOG_NORMAL,256,0,0},
    { "pshift", 	do_pshift, 	POS_FIGHTING, 3, LOG_NORMAL,256,0,0},
    { "plost", 		do_plost, 	POS_FIGHTING, 3, LOG_NORMAL,256,0,0},
    { "icelance", 	do_icelance, 	POS_FIGHTING, 3, LOG_NORMAL,256,0,0},
    { "negativity", 	do_negativity, 	POS_FIGHTING, 3, LOG_NORMAL,256,0,0},
...
found = TRUE;
	...
	//wiznet( ch, WIZ_COMMANDS, get_trust(ch), log_buf );
	log_string( log_buf );
	}
    }
