...
void do_mprandsoc(CHAR_DATA *ch, char *argument)
{
...
void do_opechoaround( OBJ_DATA *obj, char *argument )
{
    ...
    if ( ( victim=get_char_room2( NULL, obj->in_room?obj->in_room:obj->carried_by->in_room, arg ) ) == NULL )
	return;
...
void do_opgtransfer( OBJ_DATA *obj, char *argument )
{
    ...
    if ( (who = get_char_room2( NULL, (obj->in_room)?obj->in_room:obj->carried_by->in_room, arg1 )) == NULL )
	return;
...
void do_opdamage( OBJ_DATA *obj, char *argument )
{
    ...
    if( !str_cmp( target, "all" ) )
	fAll = TRUE;
    else if( ( victim = get_char_room2( NULL, obj->in_room?obj->in_room:obj->carried_by->in_room, target ) ) == NULL )
	return;
...
void do_opcall( OBJ_DATA *obj, char *argument )
{
    ...
    argument = one_argument( argument, arg );
    if ( arg[0] != '\0' )
        vch = get_char_room2( NULL, obj->in_room?obj->in_room:obj->carried_by->in_room, arg );
    argument = one_argument( argument, arg );
    if ( arg[0] != '\0' )
...
void do_opattrib( OBJ_DATA *obj, char *argument )
{
    ...
    else if ( ( ch = get_char_room2( NULL, obj->in_room ? obj->in_room : obj->carried_by->in_room, target ) ) == NULL )
	return;
...
void do_rpechoaround( ROOM_INDEX_DATA *room, char *argument )
{
    ...
    if ( ( victim=get_char_room2( NULL, room, arg ) ) == NULL )
	return;
...
void do_rpgtransfer( ROOM_INDEX_DATA *room, char *argument )
{
    ...
    if ( (who = get_char_room2( NULL, room, arg1 )) == NULL )
	return;
...
void do_rpdamage( ROOM_INDEX_DATA *room, char *argument )
{
    ...
    if( !str_cmp( target, "all" ) )
	fAll = TRUE;
    else if( ( victim = get_char_room2( NULL, room, target ) ) == NULL )
	return;
...
void do_rpcall( ROOM_INDEX_DATA *room, char *argument )
{
    ...
    argument = one_argument( argument, arg );
    if ( arg[0] != '\0' )
        vch = get_char_room2( NULL, room, arg );
    argument = one_argument( argument, arg );
    if ( arg[0] != '\0' )
