 ...
 */
...

    {
     ...
     {
        "2x exp",       1,
        spell_2xexp,   TAR_CHAR_SELF,          POS_RESTING,
        NULL,                   SLOT(75),        0,     0,
        "",                     "!2x Exp Modifier!"
     },
     {
        "death ray",          2,
        spell_deathray,      TAR_CHAR_OFFENSIVE,     POS_FIGHTING,
        NULL,                   SLOT(76),       20,     12,
        "death ray",          "!Death Ray!"
     },
     {
        "holybeam",          2,
        spell_holybeam,      TAR_CHAR_OFFENSIVE,     POS_FIGHTING,
        NULL,                   SLOT(77),       20,     12,
        "holy beam",          "!Holy Beam!"
     },
     {
        "spiritarmor",                1,
        spell_spiritarmor,            TAR_CHAR_DEFENSIVE,     POS_STANDING,
        NULL,                   SLOT(78),        5,     12,
        "",                     "Your spirit armor discipates"
     },
     {
        "barkskin",                1,
        spell_barkskin,            TAR_CHAR_DEFENSIVE,     POS_STANDING,
        NULL,                   SLOT(79),        5,     12,
        "",                     "Your skin loses its bark texture ."
     },
     {
        "primalrage",               1,
        spell_primalrage,           TAR_CHAR_DEFENSIVE,     POS_STANDING,
        NULL,                   SLOT(80),       20,    12,
        "",                     "Your Primal Rage subsides."
     },
     {
        "manatransfer",               1,
        spell_manatransfer,           TAR_CHAR_SELF,     POS_STANDING,
        NULL,                   SLOT(81),       0,    0,
        "",                     "!mana transfer!"
     },
 ...
 
{
	...
	"flameblast",		13,
	spell_null,		TAR_IGNORE,	POS_STANDING,
	&gsn_fblast,		SLOT( 0),	0,	24,
	"flameblast",		"!Flame Blast!"
    },
    {
	"windgust",		13, 
	spell_null,		TAR_IGNORE,	POS_STANDING,
	&gsn_wgust,		SLOT( 0),	0,	24,
	"windgust",		"!Wind Gust!"
    },
    {
	"chaos blast",		13, 
	spell_null,		TAR_IGNORE,	POS_STANDING,
	&gsn_cblast,		SLOT( 0),	0,	24,
	...
	"raintorrent",		13, 
	spell_null,		TAR_IGNORE,	POS_STANDING,
	&gsn_torrent,		SLOT( 0),	0,	24,
	"raintorrent",		"!Rain Torrent!"
    },

    {
	"rockslide",		13, 
	spell_null,		TAR_IGNORE,	POS_STANDING,
	&gsn_rslide,		SLOT( 0),	0,	24,
...
*/ 
    ...
    &gsn_booming,  SLOT( 0),  0,  24,  "booming voice",  "booming voice!"
       ...
       {
        "bloody shuriken",              13,        spell_null,             TAR_IGNORE,             POS_STANDING,
    ...
    /* shadow attacks (CLASS_REMOVE) */
     ...
     {  "", 99, spell_null, TAR_IGNORE, POS_STANDING,
         &gsn_moonstrike, SLOT( 0), 0, 24,
...

    {
     ...
     {
        "#C*#wSmAcK#C*#n",    99,   spell_null,   TAR_IGNORE,
        POS_STANDING, &gsn_smack,  SLOT(0),  0,  24,   
        "#C*#wSmAcK#C*#n",  "whatever"
     },
     {
        "#C*#wBaSh#C*#n",    99,   spell_null,   TAR_IGNORE,
        POS_STANDING, &gsn_bash,  SLOT(0),  0,  24,   
        "#C*#wBaSh#C*#n",  "whatever"
     },
     {
        "#C*#wThWaCk#C*#n",    99,   spell_null,   TAR_IGNORE,
