...
#define ITEM_FIRESTONE 	  	58
#define ITEM_WATERSTONE		59 
#define ITEM_EARTHSTONE		60
#define ITEM_AIRSTONE		61
...
#define XITEM_GLYPH			1
#define XITEM_RARE			2
#define XITEM_COMMON			4
#define XITEM_UNID			8
#define XITEM_RAREWEAP			16
#define XITEM_BREATH			32
...
#define QUEST_SHINOBI	     2147483648
#define QUEST_BREATH	     4294967256LL
/*
 * Tool types.
 */
#define TOOL_PEN		      1
...
#define NEW2_TORRA              32768
#define NEW2_WASH		65536
#define NEW2_CHAGI 		131072
...
extern sh_int gsn_fblast;
extern sh_int gsn_wgust;
extern sh_int gsn_torrent;
extern sh_int gsn_rslide;

extern sh_int gsn_cblast;
...
{											\
  ...
  {											\
	if( str_free((point)) == -1 )						\
       log_string2( "STRFREEing bad pointer\n"); \
    (point) = NULL;									\
  }											\
} while(0)
#else
